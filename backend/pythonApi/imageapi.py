...
url = 'https://app.nanonets.com/api/v2/OCR/Model/25c077d9-2fb2-4b02-a639-1305fc2e6bb5/LabelUrls/?async=false'

headers = {
    'accept': 'application/x-www-form-urlencoded'
}

data = {'urls' : ['https://fki.tic.heia-fr.ch/static/img/processed-strokes.png']}
